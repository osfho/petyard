class RanksController < ApplicationController
  ...
  # GET /ranks.json
  def index
    @ranks = Rank.order('power desc').all
  ...
  def create
    ...
    respond_to do |format|
      if @rank.save
        format.html { redirect_to ranks_url, notice: 'Rank was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @rank.update_attributes(params[:rank])
        format.html { redirect_to ranks_url, notice: 'Rank was successfully updated.' }
