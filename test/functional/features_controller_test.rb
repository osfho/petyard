...
class FeaturesControllerTest < ActionController::TestCase
  ...
  test "should create feature" do
    assert_difference('Feature.count') do
      post :create, feature: { position: @feature.position, title: @feature.title, url: @feature.url }
    end
  ...
  test "should update feature" do
    put :update, id: @feature, feature: { position: @feature.position, title: @feature.title, url: @feature.url }
    assert_redirected_to feature_path(assigns(:feature))
  end
