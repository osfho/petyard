...
class ProjectMembershipsControllerTest < ActionController::TestCase
  ...
  test "should create project_membership" do
    assert_difference('ProjectMembership.count') do
      post :create, project_membership: { projec_idinteger: @project_membership.projec_idinteger, role: @project_membership.role, user_id: @project_membership.user_id }
    end
  ...
  test "should update project_membership" do
    put :update, id: @project_membership, project_membership: { projec_idinteger: @project_membership.projec_idinteger, role: @project_membership.role, user_id: @project_membership.user_id }
    assert_redirected_to project_membership_path(assigns(:project_membership))
  end
